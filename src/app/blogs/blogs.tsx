...
export default function Blog() {
  return (
    <section className="bg-gradient-to-r from-teal-500 to-coral-500 py-16">
      <div className="container px-6">
        <header className="text-center mb-12">
          ...
          <p className="text-lg text-gray-700 mt-4">
            Explore curated beauty insights, trends, and expert tips.
          </p>
        </header>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12">
          {blogs.map((blog) => (
            <div
              key={blog.id}
              className="bg-white shadow-lg rounded-xl overflow-hidden transform hover:scale-105 hover:shadow-2xl transition-all duration-300"
            >
              <Image
                className="w-full h-48 object-cover"
                src={blog.image}
              ...
              />
              <div className="p-6">
                <h2 className="text-sm font-medium text-pink-500 mb-2">
                  {blog.category}
                </h2>
                ...
                <div className="flex items-center justify-between text-sm text-gray-500">
                  <Link href={`/post/${blog.id}`} passHref>
                    <li className="flex items-center font-medium text-pink-500 hover:text-pink-700 transition-colors">
                      <span>Read More</span>
                      <svg
                        className="w-4 h-4 ml-2"
